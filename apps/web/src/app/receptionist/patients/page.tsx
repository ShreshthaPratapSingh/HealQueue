...
const patients = [
  { id: 1, name: "Sneha Iyer", queue: 1, type: "Online" as const, status: "Done" as const, phone: "+91 98765 43210", age: 28 },
  { id: 2, name: "Amit Desai", queue: 2, type: "Walk-in" as const, status: "Done" as const, phone: "+91 87654 32109", age: 45 },
  { id: 3, name: "Rahul Verma", queue: 3, type: "Walk-in" as const, status: "Done" as const, phone: "+91 76543 21098", age: 32 },
  { id: 4, name: "Priya Kapoor", queue: 4, type: "Online" as const, status: "Serving" as const, phone: "+91 65432 10987", age: 38 },
  { id: 5, name: "Karan Malhotra", queue: 5, type: "Walk-in" as const, status: "Waiting" as const, phone: "+91 54321 09876", age: 50 },
  { id: 6, name: "Deepa Joshi", queue: 6, type: "Online" as const, status: "Waiting" as const, phone: "+91 43210 98765", age: 29 },
  { id: 7, name: "Arjun Nair", queue: 7, type: "Walk-in" as const, status: "Waiting" as const, phone: "+91 32109 87654", age: 41 },
  { id: 8, name: "Meera Reddy", queue: 8, type: "Online" as const, status: "Waiting" as const, phone: "+91 21098 76543", age: 35 },
  { id: 9, name: "Rohit Sharma", queue: 9, type: "Walk-in" as const, status: "Waiting" as const, phone: "+91 10987 65432", age: 27 },
];
...
export default function PatientsPage() {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
      ...
      <p className="mb-8 text-sm text-text-secondary">View all patients checked in today</p>
          ...
          >
            ...
            <div className="col-span-3">
              <span className={`inline-flex items-center rounded-full border px-2.5 py-1 text-[10px] font-semibold ${
                p.status === "Serving" ? "bg-primary-50 text-primary border-primary/20" :
                p.status === "Waiting" ? "bg-gray-50 text-text-secondary border-border-light" :
                "bg-accent-green-light text-accent-green border-accent-green/20"
              }`}>
                {p.status === "Serving" && <span className="mr-1.5 h-1.5 w-1.5 rounded-full bg-primary animate-pulse" />}
                {p.status}
              </span>
            </div>
          </motion.div>
