      ...
      >
        ...
        <nav className="flex-1 space-y-0.5 overflow-y-auto px-3 py-2">
          {sidebarLinks.map((link) => (
            ...
            >
              <span className={pathname === link.href || pathname.startsWith(link.href + "/") ? "text-primary" : "text-text-muted"}>
                {link.icon}
              </span>
              {link.label}
            </Link>
        ...
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-border-light bg-white/80 px-6 backdrop-blur-xl">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2.5">
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-primary to-primary-dark text-white font-bold text-sm shadow-md shadow-primary/20">
                A
              </div>
