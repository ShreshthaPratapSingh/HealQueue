  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-bg-alt px-4 py-12">
      ...
      <div className="relative w-full max-w-md">
        ...
        {/* Login Card */}
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.15 }} className="rounded-2xl border border-border-light bg-white p-8 shadow-xl shadow-black/3">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-border bg-bg-alt py-3.5 pr-4 pl-11 text-sm text-text-primary placeholder:text-text-muted outline-none transition-all duration-200 focus:border-primary focus:bg-white focus:ring-2 focus:ring-primary/10"
                />
              </div>
            </div>
